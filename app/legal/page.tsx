    ...
    <main id="main-content">
      ...
      <section className="page-body shell legal-copy">
        ...
        <p>
          ...
          protected reader. PayPal processes checkout and payment details;
          Dzonyx stores only the PayPal order or subscription reference and
          access status needed to deliver purchased comics. Dzonyx does not
